...
void _noteSerialize(
  ...
  writer.writeDateTime(offsets[2], object.lastModifier);
...
Note _noteDeserialize(
  ...
  final object = Note(
    ...
    id: id,
    lastModifier: reader.readDateTime(offsets[2]),
...
extension NoteQueryFilter on QueryBuilder<Note, Note, QFilterCondition> {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> lastModifierEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'lastModifier',
        value: value,
      ));
    });
  }

  QueryBuilder<Note, Note, QAfterFilterCondition> lastModifierGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> lastModifierLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> lastModifierBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension NoteQuerySortBy on QueryBuilder<Note, Note, QSortBy> {
  ...
  QueryBuilder<Note, Note, QAfterSortBy> sortByLastModifier() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastModifier', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> sortByLastModifierDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastModifier', Sort.desc);
    });
  }
...
extension NoteQuerySortThenBy on QueryBuilder<Note, Note, QSortThenBy> {
  ...
  QueryBuilder<Note, Note, QAfterSortBy> thenByLastModifier() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastModifier', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> thenByLastModifierDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastModifier', Sort.desc);
    });
  }
...
extension NoteQueryWhereDistinct on QueryBuilder<Note, Note, QDistinct> {
  ...
  QueryBuilder<Note, Note, QDistinct> distinctByLastModifier() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'lastModifier');
    });
  }
...
extension NoteQueryProperty on QueryBuilder<Note, Note, QQueryProperty> {
  ...
  QueryBuilder<Note, DateTime, QQueryOperations> lastModifierProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'lastModifier');
    });
  }
